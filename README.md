...
Simply pulling `lscr.io/linuxserver/rdesktop:ubuntu-openbox` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
services:
  rdesktop:
    image: lscr.io/linuxserver/rdesktop:ubuntu-openbox
...
docker run -d \
  ...
  --restart unless-stopped \
  lscr.io/linuxserver/rdesktop:ubuntu-openbox
```
...
* image version number
  * `docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/rdesktop:ubuntu-openbox`
...
* Update the image: `docker pull lscr.io/linuxserver/rdesktop:ubuntu-openbox`
...
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/rdesktop:ubuntu-openbox .
```
