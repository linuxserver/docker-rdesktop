...
Simply pulling `lscr.io/linuxserver/rdesktop:ubuntu-i3` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
services:
  rdesktop:
    image: lscr.io/linuxserver/rdesktop:ubuntu-i3
...
docker run -d \
  ...
  --restart unless-stopped \
  lscr.io/linuxserver/rdesktop:ubuntu-i3
...
* image version number
  * `docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/rdesktop:ubuntu-i3`
...
* Update the image: `docker pull lscr.io/linuxserver/rdesktop:ubuntu-i3`
...
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/rdesktop:ubuntu-i3 .
```
