...
<!-- Please read the https://github.com/linuxserver/docker-rdesktop/blob/openbox-bionic/.github/CONTRIBUTING.md -->
...
* Update the image: `docker pull lscr.io/linuxserver/rdesktop`
