...
Simply pulling `lscr.io/linuxserver/rdesktop:ubuntu-icewm` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
docker run -d \
  ...
  --restart unless-stopped \
  lscr.io/linuxserver/rdesktop:ubuntu-icewm
```
...
* image version number
  * `docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/rdesktop:ubuntu-icewm`
...
* Update the image: `docker pull lscr.io/linuxserver/rdesktop:ubuntu-icewm`
...
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/rdesktop:ubuntu-icewm .
```
