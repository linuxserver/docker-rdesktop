...
Instead edit the [readme-vars.yml](https://github.com/linuxserver/docker-rdesktop/edit/kde-focal/readme-vars.yml).
...
If you are modifying the Dockerfiles or any of the startup scripts in [root](https://github.com/linuxserver/docker-rdesktop/tree/kde-focal/root), add an entry to the changelog
